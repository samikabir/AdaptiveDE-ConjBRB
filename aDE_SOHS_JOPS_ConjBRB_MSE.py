...
def de(fobj, dimensions, bounds, popsize=160, its=10): #popsize = 170 
    mut=0.8 #F
    crossp=0.7 #CR       
...
it = list(de(fobj3, 41, bounds=[(0, 1)]))    
print(it[-1])        
...
if (refvl[1] == 3):
    ...
    it = list(de(fobj4, 70, bounds=[(0, 1)]))   
    print(it[-1])
    ...
    it = list(de(fobj5, 107, bounds=[(0, 1)]))   
    print(it[-1])
    ...
    it = list(de(fobj6, 152, bounds=[(0, 1)]))   
    print(it[-1])
...
if (refValList[2] == 2):  
    it = list(de(fobj2, 20, bounds=[(0, 1)]))    
    print(it[-1])
